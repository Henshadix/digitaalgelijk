Write-Host "===== Poortconflict oplossen en wijzigingen naar GitHub pushen =====" -ForegroundColor Cyan
Write-Host ""
...
Invoke-Git "commit -m `"Fix: Poortconflict opgelost door externe poort te wijzigen naar 3002`""
