Write-Host "===== Bestanden bijwerken en naar GitHub pushen =====" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "3. easypanel.json bijwerken..." -ForegroundColor Yellow
...
Set-Content -Path "easypanel.json" -Value $easypanelContent
Write-Host "easypanel.json is bijgewerkt!" -ForegroundColor Green
Write-Host ""

# Test de server
Write-Host "4. Server testen..." -ForegroundColor Yellow
...
Write-Host "Server is gestart met process ID: $($serverProcess.Id)" -ForegroundColor Green
...
Invoke-Git "add server.js docker-compose.yml easypanel.json"
