Write-Host "===== Bestanden bijwerken voor Easypanel =====" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "3. Klaar! De bestanden zijn bijgewerkt." -ForegroundColor Green
Write-Host "Nu moet je deze bestanden handmatig naar GitHub pushen en je applicatie in Easypanel herstarten." -ForegroundColor Yellow
Write-Host ""
